...
public class Manish_Algo {
    private int num;
    private String word;
    private String[] numnames={"","One","Two","Three","Four","Five","Six",
            "Seven","Eight","Nine","Ten","Eleven", "Twelve","Thirteen","Fourteen",
            "Fifteen","Sixteen","Seventeen","Eighteen","Nineteen"};
    private String[] tensname={"","Ten","Twenty","Thirty","Forty","Fifty",
            "Sixty","Seventy","Eighty","Ninety"};

    public Manish_Algo(int num) {
        this.num = num;
    }
